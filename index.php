      ...
      <div class="carousel-item active position-relative">
        ...
        <div class="carousel-caption position-absolute top-50 start-50 translate-middle text-center text-white">
          <?php if (isset($_SESSION['nama'])): ?>
            <h1 class="fw-bold display-5">Selamat Datang!</h1>
          <?php else: ?>
    ...
    <div class="row g-4 align-items-stretch">
      ...
      <div class="col-lg-6">
        <div class="row g-4">
          ...
          <div class="col-6">
            <img src="img/prambanan.jpg" class="img-fluid rounded-4 shadow-sm" style="object-fit: cover; height: 200px; width: 100%;" alt="Borobudur 4">
          </div>
          <div class="col-6">
            <img src="img/prambanan2.jpg" class="img-fluid rounded-4 shadow-sm" style="object-fit: cover; height: 200px; width: 100%;" alt="Borobudur 5">
          </div>
        </div>
      </div>
